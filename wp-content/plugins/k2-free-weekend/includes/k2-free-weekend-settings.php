...
class K2_free_weekend_settings {
    ...
    public function register_settings(){
        $args = array(
            ...
            'page'			=> "k2_free_weekend_settings_page",
            'description'	=> __("Configuration for the free weekend media.", 'afb'),
        );
        $settings_example_section = new k2_free_weekend_settings_section($args);

        $args = array(
            'id'				=> 'k2_free_weekend_podcast_ids',
            'title'				=> __("Podcast IDs", 'afb'),
            'page'				=> 'k2_free_weekend_settings_page',
            'section'			=> 'general_settings',
            'description'		=> __("The IDs of the podcasts which should show the free weekend message, separated by commas.", 'afb'),
            'type'				=> 'textarea', // text, textarea, password, checkbox
            'option_group'		=> "settings_page_k2_free_weekend_settings_page",
        );
        $k2_free_weekend_show_ads_after = new k2_free_weekend_settings_field($args);
    ...
    public function add_theme_settings_page(){
        $theme_page = add_options_page( __("K2 Free Weekend Configuration", "afb"), __("K2 Free Weekend Configuration", "afb"), 'switch_themes', 'k2_free_weekend_settings_page', array($this, 'lh_settings_page') );
    ...
    public function lh_settings_page(){
        ...
        <div class="wrap">
            ...
            <h2><?php _e("K2 Free Weekend Confiuration", 'afb'); ?></h2>

            <form action="options.php" method="post">
                <?php
                settings_fields('settings_page_k2_free_weekend_settings_page');
                do_settings_sections('k2_free_weekend_settings_page');
                ?>
                <p class="submit">
    ...
    public function theme_settings_admin_notices(){
        ...
        if(isset($_GET['settings-updated']) && $_GET['settings-updated'] == true){
            add_settings_error('k2_free_weekend_settings_page', 'k2_free_weekend_settings_page', __("Successfully updated.", 'afb') , 'updated');
        }

        settings_errors('k2_free_weekend_settings_page');

    }

}
$lh_theme_settings = new K2_free_weekend_settings();


/**
 * lh_settings_section class.
 */
class k2_free_weekend_settings_section {
 ...
 */
class k2_free_weekend_settings_field {
