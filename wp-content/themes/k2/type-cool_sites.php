<?php
$k2ptype = get_post_type_object('cool_sites');
...
<section class="section-feature">
	...
	<section class="section-feature-posts">
		<h1 class="arrow">Featured Cool Sites</h1>
		<div class="grid clearfix">
			<?php section_featured('cool_sites'); ?>
		</div>
	</section>

	<section class="section-nav-meta clearfix">
		<nav class="section-categories">
			<h1 class="arrow">Cool Sites Categories</h1>
			<ul clas="category-nav">
			<?php 
			$categories = get_terms('cool_sites_categories', array(
				'orderby' => 'name',
				'hide_empty' => 1
			));
...
<section class="section-grid">
	...
	<div class="grid-filter clearfix">
		<span class="hide-desktop"><span>Latest Cool Sites</span><i class="fa fa-chevron-down hide-desktop"></i></span>
		<ul class="hide-mobile hide-tablet">
			...
			<li><a href="javascript:void(0)" class="filter-cool-sites filter-active" data-post-type="cool_sites">Cool Sites</a></li>
	...
	<div class="grid-subscribe hide-mobile">
		<a href="javascript:void(0)" onClick="ga('send', 'event', 'Cool Sites', 'Click', 'Click through to subscribe modal');" data-modal="subscribe-modal"><span>Get the latest in your inbox <i class="fa fa-chevron-right"></i></span></a>
	</div>

	<div class="grid clearfix">
		<?php section_grid(1, 'cool_sites'); ?>
	</div>
	<script type="text/javascript">
	jQuery(document).ready(function($) {
		...
		$('.load-more').on('click', function() {
			...
			$.ajax({
				url: ajaxurl,
				data: {action: 'section_grid', page: i, section: 'cool_sites'},
		...
		ga('send', 'event', 'Cool Sites', 'Click', 'Load Page: ' + i);
