...
<item rdf:about="<?php the_permalink_rss() ?>">
	...
	$thumbnail_image = wp_get_attachment_image_src($image_id, 'small-square-thumbnail')[0];
	if($large_image) {
	?>
	<media:content url="<?php echo $large_image; ?>" medium="image" isDefault="true" width="970" height="546" />
	<?php } 
	if($thumbnail_image) {
	?>
	<media:thumbnail url="<?php echo $thumbnail_image; ?>" width="148" height="148" />
	<?php } ?>
	<dc:date><?php echo mysql2date('Y-m-d\TH:i:s\Z', $post->post_date_gmt, false); ?></dc:date>
<!--    <dc:creator><![CDATA[Kim Komando]]></dc:creator> -->
    <dc:creator><?php htmlspecialchars(the_author(), ENT_XML1); ?></dc:creator>
