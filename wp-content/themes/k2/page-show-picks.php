...
<div class="content-left clearfix">
	...
	<div class="show-picks-intro">Welcome to the "Show Picks" page! Here, you'll find quick links to everything Kim mentions on her show each week. Never miss a week: <a href="<?php echo STATION_FINDER_BASE_URI; ?>">find your station</a> now.</div>
	
	<?php 
	$args = array('posts_per_page' => 1, 'post_type' => 'previous_shows');
...
<div class="show-picks-mini-nav hide-mobile">
		...
		<div class="show-picks-grid">			
			...
			<article class="show-picks-grid-item money">
				<div class="show-picks-grid-item-header"><span class="icon-k2-trophy"></span> Money Tip <div class="k2-show-pick-sponsored-by"><a href="//www.swagbucks.com/?lp=2039&cmp=1085&cxid=moneytip"><span class="k2-show-pick-sponsored-by-text">Sponsored By</span><img src="<?php echo k2_get_static_url('v2'); ?>/img/swagbucks-logo-100.png" /></a></div></div>
	...
	<p>To join Kim's Club to watch this show's video or get the podcast as well as past shows, <a href="<?php echo CLUB_BASE_URI; ?>/products?r=<?php echo urlencode(site_url($url)); ?>">click here to join now</a>.</p>
	...
	<div class="show-picks-nav">
		...
		<a href="<?php bloginfo('url') ?>/previous-shows" class="picks-nav-item">
			<div class="picks-nav-icon calendar"><span class="icon-k2-calendar"></span></div><div class="picks-nav-text">Past Picks</div>
		</a>
