<?php
$k2ptype = get_post_type_object('columns');
...
<section class="section-feature">
	...
	<section class="section-feature-posts">
		<h1 class="arrow">Featured Columns</h1>
		<div class="grid clearfix">
			<?php section_featured('columns'); ?>
		</div>
	</section>

	<section class="section-nav-meta clearfix">
		<nav class="section-categories">
			<h1 class="arrow">Column Categories</h1>
			<ul clas="category-nav">
			<?php 
			$categories = get_terms('columns_categories', array(
				'orderby' => 'name',
				'hide_empty' => 1
			));
...
<section class="section-grid">
	...
	<div class="grid-filter clearfix">
		<span class="hide-desktop"><span>Latest Columns</span><i class="fa fa-chevron-down hide-desktop"></i></span>
		<ul class="hide-mobile hide-tablet">
			...
			<li><a href="javascript:void(0)" class="filter-columns filter-active" data-post-type="columns">Columns</a></li>
	...
	<div class="grid-subscribe hide-mobile">
		<a href="javascript:void(0)" onClick="ga('send', 'event', 'Columns', 'Click', 'Click through to subscribe modal');" data-modal="subscribe-modal"><span>Get the latest in your inbox <i class="fa fa-chevron-right"></i></span></a>
	</div>

	<div class="grid clearfix">
		<?php section_grid(1, 'columns'); ?>
	</div>
	<script type="text/javascript">
	jQuery(document).ready(function($) {
		...
		$('.load-more').on('click', function() {
			...
			$.ajax({
				url: ajaxurl,
				data: {action: 'section_grid', page: i, section: 'columns'},
		...
		ga('send', 'event', 'Columns', 'Click', 'Load Page: ' + i);
