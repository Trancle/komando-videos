<?php
$k2ptype = get_post_type_object('happening_now');
...
<section class="section-feature">
	...
	<section class="section-feature-posts">
		<h1 class="arrow">What's Happening Now</h1>
		<div class="grid clearfix">
			<?php section_featured('happening_now'); ?>
		</div>
	</section>

	<section class="section-nav-meta clearfix">
		<nav class="section-categories">
			<h1 class="arrow">Happening Now Categories</h1>
			<ul clas="category-nav">
			<?php 
			$categories = get_terms('happening_now_categories', array(
				'orderby' => 'name',
				'hide_empty' => 1
			));
...
<section class="section-grid">
	...
	<div class="grid-filter clearfix">
		<span class="hide-desktop"><span>What's Happening Now</span><i class="fa fa-chevron-down hide-desktop"></i></span>
	...
	<div class="grid-subscribe hide-mobile">
		<a href="javascript:void(0)" onClick="ga('send', 'event', 'Happening Now', 'Click', 'Click through to subscribe modal');" data-modal="subscribe-modal"><span>Get the latest in your inbox <i class="fa fa-chevron-right"></i></span></a>
	</div>

	<div class="grid clearfix">
		<?php section_grid(1, 'happening_now'); ?>
	</div>
	<script type="text/javascript">
	jQuery(document).ready(function($) {
		...
		$('.load-more').on('click', function() {
			...
			$.ajax({
				url: ajaxurl,
				data: {action: 'section_grid', page: i, section: 'happening_now'},
		...
		ga('send', 'event', 'Happening Now', 'Click', 'Load Page: ' + i);
