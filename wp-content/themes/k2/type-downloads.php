<?php
$k2ptype = get_post_type_object('downloads');
...
<section class="section-feature">
	...
	<section class="section-feature-posts">
		<h1 class="arrow">Featured Downloads</h1>
		<div class="grid clearfix">
			<?php section_featured('downloads'); ?>
		</div>
	</section>

	<section class="section-nav-meta clearfix">
		<nav class="section-categories">
			<h1 class="arrow">Downloads Categories</h1>
			<ul clas="category-nav">
			<?php 
			$categories = get_terms('downloads_categories', array(
				'orderby' => 'name',
				'hide_empty' => 1
			));
...
<section class="section-grid">
	...
	<div class="grid-filter clearfix">
		<span class="hide-desktop"><span>Latest Downloads</span><i class="fa fa-chevron-down hide-desktop"></i></span>
		<ul class="hide-mobile hide-tablet">
			...
			<li><a href="javascript:void(0)" class="filter-downloads filter-active" data-post-type="downloads">Downloads</a></li>
	...
	<div class="grid-subscribe hide-mobile">
		<a href="javascript:void(0)" onClick="ga('send', 'event', 'Downloads', 'Click', 'Click through to subscribe modal');" data-modal="subscribe-modal"><span>Get the latest in your inbox <i class="fa fa-chevron-right"></i></span></a>
	</div>

	<div class="grid clearfix">
		<?php section_grid(1, 'downloads'); ?>
	</div>
	<script type="text/javascript">
	jQuery(document).ready(function($) {
		...
		$('.load-more').on('click', function() {
			...
			$.ajax({
				url: ajaxurl,
				data: {action: 'section_grid', page: i, section: 'downloads'},
		...
		ga('send', 'event', 'Downloads', 'Click', 'Load Page: ' + i);
