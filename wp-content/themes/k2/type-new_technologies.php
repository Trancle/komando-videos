<?php
$k2ptype = get_post_type_object('new_technologies');
...
<section class="section-feature">
	...
	<section class="section-feature-posts">
		<h1 class="arrow">New Technology</h1>
		<div class="grid clearfix">
			<?php section_featured('new_technologies'); ?>
		</div>
	</section>

	<section class="section-nav-meta clearfix">
		<nav class="section-categories">
			<h1 class="arrow">New Technology Categories</h1>
			<ul clas="category-nav">
			<?php 
			$categories = get_terms('new_technologies_categories', array(
				'orderby' => 'name',
				'hide_empty' => 1
			));
		...
		<div class="ad square-ad home-ad clearfix">
			<div id="ad-rectangle-featured-3" style="min-width:300px; min-height:50px; margin:auto;">
				<script type='text/javascript'>
				googletag.cmd.push(function() { googletag.display('ad-rectangle-featured-3'); });
				</script>
			</div>
		</div>
	</section>
...
<section class="section-grid">
	...
	<div class="grid-filter clearfix">
		<span class="hide-desktop"><span>New Technology</span><i class="fa fa-chevron-down hide-desktop"></i></span>
	...
	<div class="grid-subscribe hide-mobile">
		<a href="javascript:void(0)" onClick="ga('send', 'event', 'New Technology', 'Click', 'Click through to subscribe modal');" data-modal="subscribe-modal"><span>Get the latest in your inbox <i class="fa fa-chevron-right"></i></span></a>
	</div>

	<div class="grid clearfix">
		<?php section_grid(1, 'new_technologies'); ?>
	</div>
	<script type="text/javascript">
	jQuery(document).ready(function($) {
		...
		$('.load-more').on('click', function() {
			...
			$.ajax({
				url: ajaxurl,
				data: {action: 'section_grid', page: i, section: 'new_technologies'},
		...
		ga('send', 'event', 'New Technology', 'Click', 'Load Page: ' + i);
