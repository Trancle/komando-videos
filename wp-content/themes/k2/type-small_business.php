<?php
$k2ptype = get_post_type_object('small_business');
...
<section class="section-feature">
	...
	<section class="section-feature-posts">
		<h1 class="arrow">Featured Small Business</h1>
		<div class="grid clearfix">
			<?php section_featured('small_business'); ?>
		</div>
	</section>

	<section class="section-nav-meta clearfix">
		<nav class="section-categories">
			<h1 class="arrow">Small Business Categories</h1>
			<ul clas="category-nav">
			<?php 
			$categories = get_terms('small_business_categories', array(
				'orderby' => 'name',
				'hide_empty' => 1
			));
...
<section class="section-grid">
	...
	<div class="grid-filter clearfix">
		<span class="hide-desktop"><span>Small Business</span><i class="fa fa-chevron-down hide-desktop"></i></span>
	...
	<div class="grid-subscribe hide-mobile">
		<a href="javascript:void(0)" onClick="ga('send', 'event', 'Small Business', 'Click', 'Click through to subscribe modal');" data-modal="subscribe-modal"><span>Get the latest in your inbox <i class="fa fa-chevron-right"></i></span></a>
	</div>

	<div class="grid clearfix">
		<?php section_grid(1, 'small_business'); ?>
	</div>
	<script type="text/javascript">
	jQuery(document).ready(function($) {
		...
		$('.load-more').on('click', function() {
			...
			$.ajax({
				url: ajaxurl,
				data: {action: 'section_grid', page: i, section: 'small_business'},
		...
		ga('send', 'event', 'Small Business', 'Click', 'Load Page: ' + i);
