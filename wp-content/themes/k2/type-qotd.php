...
<section class="content-left" role="main">
	...
	<?php 
	$args = array('posts_per_page' => 1, 'post_type' => 'qotd');
	...
	<article id="post-<?php echo get_the_ID(); ?>" <?php post_class('clearfix'); ?>>
		...
		<div class="article-content clearfix">
			...
			<div class="article-content-share-wrapper hide-mobile hide-tablet<?php if(wp_is_mobile()) { echo ' stick-bottom'; } ?>">
				<div class="article-content-share-buttons clearfix">
					<div class="article-content-share-buttons-toggle"><span>Share</span> <i class="fa fa-caret-down"></i></div>
