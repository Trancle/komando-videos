<?php
$k2ptype = get_post_type_object('tips');
...
<section class="section-feature">
	...
	<section class="section-feature-posts">
		<h1 class="arrow">Featured Tips</h1>
		<div class="grid clearfix">
			<?php section_featured('tips'); ?>
		</div>
	</section>

	<section class="section-nav-meta clearfix">
		<nav class="section-categories">
			<h1 class="arrow">Tips Categories</h1>
			<ul clas="category-nav">
			<?php 
			$categories = get_terms('tips_categories', array(
				'orderby' => 'name',
				'hide_empty' => 1
			));
...
<section class="section-grid">
	...
	<div class="grid-filter clearfix">
		<span class="hide-desktop"><span>Latest Tips</span><i class="fa fa-chevron-down hide-desktop"></i></span>
		<ul class="hide-mobile hide-tablet">
			...
			<li><a href="javascript:void(0)" class="filter-tips filter-active" data-post-type="tips">Tips</a></li>
			<li><a href="<?php echo NEWS_BASE_URI; ?>" class="filter-news" data-post-type="news">News</a></li>
		</ul>
	</div>

	<div class="grid-subscribe hide-mobile">
		<a href="javascript:void(0)" onClick="ga('send', 'event', 'Tips', 'Click', 'Click through to subscribe modal');" data-modal="subscribe-modal"><span>Get the latest in your inbox <i class="fa fa-chevron-right"></i></span></a>
	</div>

	<div class="grid clearfix">
		<?php section_grid(1, 'tips'); ?>
	</div>
	<script type="text/javascript">
	jQuery(document).ready(function($) {
		...
		$('.load-more').on('click', function() {
			...
			$.ajax({
				url: ajaxurl,
				data: {action: 'section_grid', page: i, section: 'tips'},
		...
		ga('send', 'event', 'Tips', 'Click', 'Load Page: ' + i);
