...
add_action( 'init', 'vlog_register_mobile_menus' );

if( !function_exists( 'vlog_register_mobile_menus' ) ) :
	function vlog_register_mobile_menus() {
		register_nav_menus( array( 'vlog_mobile_menu' => 'Mobile Menu' ) );
	}
endif;
