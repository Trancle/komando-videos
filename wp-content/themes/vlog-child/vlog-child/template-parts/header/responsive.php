<div id="vlog-responsive-header" class="vlog-responsive-header hidden-lg hidden-md">
	<div class="vlog-responsive-top-bar">
		<div class="container">
			<div class="row">
	...
	<div id="dl-menu" class="dl-menuwrapper">
		...
		<?php if ( has_nav_menu( 'vlog_main_menu' ) ) : ?>
				...
				<?php wp_nav_menu( array( 'theme_location' => 'vlog_mobile_menu', 'container'=> '', 'menu_class' => 'vlog-mob-nav dl-menu', 'walker' => new vlog_Menu_Walker ) ); ?>
		<?php else: ?>
